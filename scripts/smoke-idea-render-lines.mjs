...
// 2026-07-08改訂・事前計算方式: solveFixedSizeShape等の重計算はscripts/precompute-idea-layouts.mjs
// (ビルド外)へ移した。IdeasPoster.tsx/IdeaShapeCard.tsxはdata/idea-layouts.jsonを読んで描画する
// だけになったため、/ideasの初回ロードは軽い(旧実装の実測2.2〜2.3分から大幅短縮)。それでも
// dev serverの初回コンパイル等の揺らぎに備え、タイムアウトには十分な余裕を残す
